      ...
      <div className="min-h-[90vh] bg-brand-white grid-blueprint flex items-center justify-center p-4">
        ...
        >
          ...
          <p className="font-mono text-[9px] text-gray-400 text-center uppercase tracking-widest mb-8 leading-relaxed">
            Diperlukan verifikasi kredensial administratif. Hanya akun terdaftar yang diizinkan masuk.
          </p>

          {user && !authenticated && (
             <p className="font-mono text-[10px] text-brand-red text-center mb-4">Akses Ditolak untuk: {user.email}</p>
          )}
